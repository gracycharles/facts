...
export const TEN_SECOND_OPTIMIZATIONS: Record<number, TenSecondScriptOptimization> = {
  1: {
    ...
    overlayLocationBadge: "GoMA | Royal Exchange Square, Glasgow",
  ...
  4: {
    ...
    overlayCoreFact: "World's 3rd oldest metro (1896) - a 6.5-mile circle that never expanded by an inch!",
  ...
  5: {
    ...
    overlayHook: "GREYFRIARS BOBBY 14-YEAR VIGIL",
    overlayCoreFact: "Guarded master's grave from 1858 to 1872 - Lord Provost bought his collar and licence!",
  ...
  6: {
    ...
    overlayHook: "THE GLASGOW BARRAS AND BALLROOM",
  ...
  7: {
    ...
    overlayHook: "AULD REEKIE AND GARDYLOO",
  ...
  12: {
    ...
    overlayHook: "THE REAL JEKYLL AND HYDE",
  ...
  17: {
    ...
    overlayHook: "KELVINGROVE'S 'BACKWARDS' MYTH",
    overlayCoreFact: "Architect didn't jump from the roof! Features Salvador Dalí's £10M masterpiece.",
    overlayLocationBadge: "Kelvingrove Art Gallery | Argyle Street, Glasgow",
  ...
  18: {
    ...
    overlayLocationBadge: "St Giles' Cathedral | High Street, Edinburgh",
  ...
  21: {
    ...
    overlayHook: "BURKE AND HARE: BODY SNATCHERS",
  ...
  25: {
    ...
    overlayLocationBadge: "Helensburgh and Royal College | Glasgow",
  ...
  27: {
    ...
    overlayHook: "EDINBURGH CASTLE VOLCANIC PLUG",
  ...
  28: {
    ...
    overlayHook: "MACKINTOSH AND THE WILLOW TEAROOMS",
    overlayCoreFact: "1903 Art Nouveau masterpiece built for temperance to give workers an alternative to pubs!",
    overlayLocationBadge: "Mackintosh at the Willow | Sauchiehall Street, Glasgow",
  ...
  29: {
    ...
    overlayCoreFact: "Telephone, Penicillin, Steam Engine, TV, Radar and Tyres - all created by Scottish minds!",
  ...
  30: {
    ...
    overlayHook: "MARY KING'S BURIED UNDERGROUND STREET",
  ...
  31: {
    ...
    overlayLocationBadge: "Exchange Place | Royal Exchange Square, Glasgow",
  ...
  32: {
    ...
    overlayCoreFact: "200 feet tall with 287 spiral steps, 68 carved book characters and Sir Walter Scott's dog!",
    overlayLocationBadge: "Scott Monument | Princes Street, Edinburgh",
  ...
  35: {
    ...
    overlayHook: "EDINBURGH'S WITCHES' WELL",
  ...
  37: {
    ...
    overlayCoreFact: "Victorian cobbled mews with thousands of twinkling fairy lights and 1921 vintage cinema!",
  ...
  38: {
    ...
    overlayHook: "CALTON HILL: EDINBURGH'S DISGRACE",
  ...
  39: {
    ...
    overlayLocationBadge: "Scottish Highlands and Pollok Park, Glasgow",
  ...
  41: {
    ...
    overlayCoreFact: "120 chambers inside the 1788 bridge - slums and moonshine stills forgotten for 100 years!",
  ...
  42: {
    ...
    overlayCoreFact: "World's biggest animated neon sign and sprung Canadian maple floor that bounces like a trampoline!",
  ...
  43: {
    ...
    overlayHook: "TARTAN WAS ILLEGAL FOR 36 YEARS",
  ...
  44: {
    ...
    overlayHook: "COVENANTERS' PRISON AND POLTERGEIST",
  ...
  47: {
    ...
    overlayHook: "DEACON BRODIE'S SECRET DOUBLE LIFE",
  ...
  49: {
    ...
    overlayCoreFact: "Christmas was banned for nearly 400 years (until 1958)! First footing with coal, whisky and Burns!",
    overlayLocationBadge: "Princes Street and George Square | Scotland",
  ...
  50: {
    ...
    overlayHook: "SCOTLAND FOREVER: 50 UNBELIEVABLE FACTS",
